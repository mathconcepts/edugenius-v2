...
CREATE INDEX idx_trend_source ON trend_signals(source, collected_at DESC);
CREATE INDEX idx_trend_topic ON trend_signals(topic_match) WHERE topic_match IS NOT NULL;
...
CREATE INDEX idx_priority_score ON content_priorities(priority_score DESC);
